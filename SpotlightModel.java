...
/**
 * This class models a spotlight hierarchical model
...
public class SpotlightModel {
    ...
    public SpotlightModel(GL3 gl, Camera cameraIn, Light[] lightIn) {
        ...
        ((Spotlight)light).setDirection(lightDirection);
    }
    public void render(GL3 gl, double elapsedTime) {
        //updateBranches(elapsedTime);
        rotateTopAngle = (float)elapsedTime * rotationSpeed;
